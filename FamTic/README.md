...
Welcome! This is the support page for **FamTic** (팸틱), an iPhone app that keeps a family's shared
...
the app. It is served by GitHub Pages from the
[`lovelsh.github.io`](https://github.com/lovelsh/lovelsh.github.io) user-site repository.
...
### Contact
The fastest way to reach us is by email at **lovelsh.support@gmail.com**.
...
- 개인정보 처리방침: [privacy](./privacy.md)
- 자주 묻는 질문(FAQ): [support](./support.md)

### 앱 소개
팸틱(FamTic)은 가족·부부·연인이 함께 챙겨야 할 일을 한 앱에 모아 두는 iPhone 전용 앱입니다.
일정, 기념일(양력·음력), 장보기, 학원비 납부일, 메모, 여행 준비물, 생활비를 모듈별로 정리해 두고
...
### 문의 방법
가장 빠른 문의 방법은 **lovelsh.support@gmail.com** 로 이메일을 보내 주시는 것입니다.
